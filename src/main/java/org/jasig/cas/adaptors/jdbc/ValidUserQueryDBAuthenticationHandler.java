...
//            }
            System.out.println("pwd="+transformedCredential.getPassword());
            System.out.println("values.get(key)="+values.get("pwd"));
            if(!values.get("pwd").equals(transformedCredential.getPassword())){
                throw new FailedLoginException("Password does not match value on record.");
            }
